...
public class RegisterStudentFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Student-Registration-Icon.png"))); // NOI18N
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try{
            boolean res = UserDAO.validateUser(userId);
            if(res==true){
                JOptionPane.showMessageDialog(null, "User with this userId is already registerd","Ërror!!",JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        catch(SQLException e){
            JOptionPane.showMessageDialog(null, "DB Error","RegisterStudent Error!!",JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
        ...
        try{
            ...
            int isValidUser = UserDAO.registerStudent(user);
            if(isValidUser==1){
